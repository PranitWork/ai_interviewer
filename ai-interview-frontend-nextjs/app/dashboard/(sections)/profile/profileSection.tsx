    ...
    <ProtectedRoute>
      ...
      >
        ...
        <div className="flex justify-between items-center">
          <div>
            <h2 className="text-3xl font-bold mb-1 text-voxy-text">Your Profile</h2>
          ...
          {!editMode ? (
            <motion.button
              ...
              className="px-5 py-2.5 rounded-lg font-semibold text-voxy-text bg-gradient-to-r from-voxy-primary to-voxy-secondary shadow-md hover:opacity-90 transition flex items-center gap-2"
            >
            ...
            <div className="flex gap-3">
              ...
              <motion.button
                ...
                className="px-5 py-2.5 rounded-lg font-semibold text-voxy-muted border border-voxy-border hover:text-voxy-text transition flex items-center gap-2"
              >
                <X size={16} /> Cancel
              </motion.button>
            </div>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6">
            ...
            <div className="text-center sm:text-left">
              <h3 className="text-2xl font-semibold text-voxy-text">{name}</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-8">
            ...
            <div>
              ...
              {editMode ? (
                ...
                <p className="text-voxy-text">{name}</p>
              )}
            </div>
            ...
            <div>
              ...
              <input
                ...
                readOnly
                className="w-full px-3 py-2 rounded-lg bg-voxy-surface border border-voxy-border text-voxy-muted cursor-not-allowed opacity-70"
              />
            </div>
          </div>
        </motion.div>
