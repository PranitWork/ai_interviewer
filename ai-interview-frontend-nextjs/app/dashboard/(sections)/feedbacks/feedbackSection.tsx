  ...
  if (!feedback) {
    return (
      <div className="text-center text-voxy-muted mt-20">
        <p>
          No feedback report available. Please complete your interview first.
        </p>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold mb-2">Recent Interview Feedback</h2>
          ...
          <svg className="w-full h-full transform -rotate-90">
            ...
            <motion.circle
              ...
              animate={{
                strokeDasharray: 440,
                strokeDashoffset:
                  440 - (440 * (feedback.technicalScore || 0)) / 10,
              }}
