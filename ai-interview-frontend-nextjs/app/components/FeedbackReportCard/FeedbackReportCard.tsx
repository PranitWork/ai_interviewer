          ...
          {(allFeedbacks as FeedbackItem[]).map((item) => (
            ...
            >
              ...
              <div className="flex justify-between items-center mb-3">
                <h3 className="font-bold text-lg text-voxy-primary capitalize">
  ...
  {selectedReport && (
    ...
    >
      ...
      >
        ...
        {/* === CONTENT === */}
        <div className="relative px-8 py-8 overflow-y-auto max-h-[75vh] space-y-8 custom-scroll">
          {/* === TECHNICAL SCORE === */}
          <motion.div
            whileHover={{ scale: 1.03 }}
            ...
            <div className="relative w-32 h-32 flex items-center justify-center">
              ...
              <div className="text-center">
                <p className="text-3xl font-bold text-white">
                  {selectedReport.report?.technicalScore}/10
                </p>
          ...
          >
            {[
              { title: "Communication", value: selectedReport.report?.communication },
              { title: "Confidence", value: selectedReport.report?.confidence },
            ].map((item, idx) => (
              <motion.div
                key={idx}
              ...
              >
                ...
                <p className="text-sm text-voxy-muted">{item.value || "N/A"}</p>
              </motion.div>
            ))}
          </motion.div>
          ...
          >
            ...
            <div className="group relative">
              <div className="absolute -inset-1 rounded-2xl bg-gradient-to-r from-green-500/20 to-voxy-primary/10 blur opacity-0 group-hover:opacity-100 transition" />
              <div className="relative p-5 rounded-2xl bg-voxy-surface/80 border border-voxy-border">
                ...
                {selectedReport.report?.strengths?.length ? (
                  ...
                  <p className="text-sm text-voxy-muted">No strengths found.</p>
                )}
              </div>
            </div>
            ...
            {/* WEAKNESSES */}
            <div className="group relative">
              <div className="absolute -inset-1 rounded-2xl bg-gradient-to-r from-red-500/20 to-voxy-primary/10 blur opacity-0 group-hover:opacity-100 transition" />
              <div className="relative p-5 rounded-2xl bg-voxy-surface/80 border border-voxy-border">
                <div className="flex items-center gap-2 mb-3">
                  <ThumbsDown className="text-red-400" size={20} />
                  <h4 className="font-semibold text-white">Weaknesses</h4>
                </div>
                {selectedReport.report?.weaknesses?.length ? (
                  <ul className="text-sm text-voxy-muted space-y-2">
                  ...
                  <p className="text-sm text-voxy-muted">No weaknesses found.</p>
                )}
              </div>
            </div>
          </motion.div>
